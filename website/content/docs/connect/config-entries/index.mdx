...
- [`ingress-gateway`](/docs/connect/config-entries/ingress-gateway) - defines the
  ...
  - Kubernetes kind: [`IngressGateway`](/docs/connect/config-entries/ingress-gateway)

- [`proxy-defaults`](/docs/connect/config-entries/proxy-defaults) - controls
  proxy configuration

  - Kubernetes kind: [`ProxyDefaults`](/docs/connect/config-entries/proxy-defaults)
...
- [`service-defaults`](/docs/connect/config-entries/service-defaults) - configures
  ...
  - Kubernetes kind: [`ServiceDefaults`](/docs/connect/config-entries/service-defaults)
...
- [`service-intentions`](/docs/connect/config-entries/service-intentions) - defines
  ...
  - Kubernetes kind: [`ServiceIntentions`](/docs/connect/config-entries/service-intentions)
...
- [`service-resolver`](/docs/connect/config-entries/service-resolver) - matches
  ...
  - Kubernetes kind: [`ServiceResolver`](/docs/connect/config-entries/service-resolver)

- [`service-router`](/docs/connect/config-entries/service-router) - defines
  where to send layer 7 traffic based on the HTTP route

  - Kubernetes kind: [`ServiceRouter`](/docs/connect/config-entries/service-router)
...
- [`service-splitter`](/docs/connect/config-entries/service-splitter) - defines
  ...
  - Kubernetes kind: [`ServiceSplitter`](/docs/connect/config-entries/service-splitter)
...
- [`terminating-gateway`](/docs/connect/config-entries/terminating-gateway) - defines the
  ...
  - Kubernetes kind: [`TerminatingGateway`](/docs/connect/config-entries/terminating-gateway)
